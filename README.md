...
7. [Рекомендуемые плагины VS Code](#рекомендуемые-плагины-для-vs-code)
8. [Локальные сниппеты](#локальные-сниппеты)
9. [Готовые модули](#готовые-модули)
10. [Изменения в версии 3.0.0 (от 21.04.2024)](#изменения-в-версии-300-от-21042024)
...
Также не забудьте прописать эти же шрифты в `<link preload>` в php.
...
1. В php вызвать сниппет `g-burger`
2. На ваше потенциальное меню в php добавить атрибут `data-menu`
...
1. В Php вызвать сниппет `g-graph-btn`. Он создаст кнопку для модального окна, ваша задача лишь заполнить атрибут `data-graph-path`
...
1. В Php вызвать сниппет `g-tabs`. Он создаст разметку для табов, ваша задача лишь заполнить атрибут `data-tabs`
...
1. В Php вызвать сниппет `g-tooltip`. Он создаст кнопку для модального окна, ваша задача лишь заполнить атрибуты `aria-describedby` и `id`.
...
1. В php вызвать сниппет `g-swiper`. Он создаст базовую структуру свайпер-слайдера, вам нужно добавить свой класс для свайпер-контейнера.
